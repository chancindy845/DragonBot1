 /*
* DragonBot es una creación de dragón
* DragonBot no tiene ningun fin de lucro
* Dragón se reserva todos los derechos de autor
* © 2021 Dragón, INC.
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '[❗] Este comando solo lo usa DragonBot',
...
/******JUEGOS SHANDUY LA PUTA MADRE NO TE OLVIDES******/					
  ...
  client.updatePresence(from, Presence.composing) 
	...
	case 'creador':
		...
		client.sendMessage(from, 'Hola 👋 te saluda Dragón, este es un mensaje predeterminado.\n Si quieres me puedes seguir en instagram.\n\n*Mi instagram:* http://instagram.com/dragon_fuckk,MessageType.text, { quoted: mek} )
